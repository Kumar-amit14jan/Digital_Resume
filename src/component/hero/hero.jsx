    ...
    return (
        <section className={styles.container}>
            <div className={styles.content}>
                ...
                <p className={styles.description}>I’m a Full-Stack Developer with 2+ years of experience using React, Angular, Node.js, Express, MongoDB, and MariaDB. I build fast, responsive, and secure web apps with clean UI and robust backend architecture.
